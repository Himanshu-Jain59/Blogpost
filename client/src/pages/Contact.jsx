...
const Contact = () => {
  return (
    <>
      <div className=" mt-5 mx-10 bg-[url('https://img.freepik.com/premium-photo/top-view-office-desk-workspace_160097-448.jpg?w=996')] rounded-3xl bg-[#504e4e]  h-130 bg-cover bg-no-repeat ">
        <div className="h-full  rounded-3xl backdrop-brightness-70 flex flex-col justify-center items-center ">
      ...
      {/* bg-[#42676f]  */}
      <div className=" m-10 rounded-3xl flex flex-col justify-center items-center gap-4 p-20 bg-[url('/images/forest.jpeg')]  bg-cover bg-no-repeat  ">
